                            ...
                            <ul class="mainmenu">
                                <li class="has-submenu">
                                    ...
                                    <ul class="submenu">
                                        ...
                                        <li><a class="submenu-item" href="../event-checklist1.php">Events Checklist</a></li>
                                ...
                                <li class="has-submenu">
                                    ...
                                    <ul class="submenu">
                                        <li><a class="submenu-item" href="departments.php">Departments</a></li>
                                        <li><a class="submenu-item" href="event-categories.php">Events Categories</a></li>
                                        <li><a class="submenu-item" href="sections.php">Sections</a></li>
                                        <li><a class="submenu-item" href="floors.php">Floors</a></li>
                                        <li><a class="submenu-item" href="zones.php">Zones</a></li>
                                        <li><a class="submenu-item" href="vendors.php">Vendors</a></li>
                                        <li><a class="submenu-item" href="stewards.php">Stewards</a></li>
                                        <li><a class="submenu-item" href="employee-categories.php">Employee Categories</a></li>
                                        <li><a class="submenu-item" href="employees.php">Employees</a></li>
                                        <li><a class="submenu-item" href="peaps-template.php">PEAPs Template</a></li>
                                        <li><a class="submenu-item" href="checklist.php">Checklist</a></li>
                                        <li><a class="submenu-item" href="event-position.php">Event Position</a></li>
                                        <li><a class="submenu-item" href="de-briefing-documents.php">Briefing Documents</a></li>
                                        <li><a class="submenu-item" href="acess-roles.php">Access Roles</a></li>
                                        <li><a class="submenu-item" href="settings.php">Settings</a></li>
                                        <li><a class="submenu-item" href="stewards-position.php">stewards Position</a></li>
                                        <li><a class="submenu-item" href="stewards-position-1.php">stewards Position 1</a></li>
                                        <li><a class="submenu-item" href="certification.php">certification</a></li>
                                    </ul>
                                </li>
                            </ul>
                        </div>
